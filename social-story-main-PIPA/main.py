...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_folder', default='PIPA/train')
    parser.add_argument('--image_txt',default='relation_train.txt')
    ...
    parser.add_argument('--category_number',default=16,type=int,help='The number of category of social relationship in specific dataset')
